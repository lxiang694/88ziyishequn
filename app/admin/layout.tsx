...
const NAV = [
  ...
  { href: '/admin/care/operations', label: '　└ 營運控制台', perms: ['all', 'care_operations.view', 'care_notification.manage', 'care_feedback.manage', 'care_concern.manage', 'care_quality.review', 'care_quality.manage'] },
  { href: '/admin/care/notifications', label: '　└ 站內通知與 outbox', perms: ['all', 'care_notification.manage'] },
  { href: '/admin/care/feedback', label: '　└ 家屬回饋與意見', perms: ['all', 'care_feedback.manage', 'care_concern.manage'] },
  { href: '/admin/care/quality', label: '　└ 服務品質覆核', perms: ['all', 'care_quality.review', 'care_quality.manage'] },
  { href: '/admin/care/insights', label: '　└ 營運指標', perms: ['all', 'care_insights.view'] },
  { href: '/admin/care/policies', label: '　└ 條款與隱私版本', perms: ['all', 'care_policy.manage'] },
  { href: '/admin/care/lifecycle', label: '　└ 資料保留待辦', perms: ['all', 'care_data_lifecycle.manage'] },
  { href: '/admin/care/release-readiness', label: '　└ 上線檢核', perms: ['all', 'care_release_readiness.view'] },
